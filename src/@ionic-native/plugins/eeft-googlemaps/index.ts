...
@Plugin({
  ...
  plugin: 'eeft-plugin-googlemaps',
  repo: 'https://github.com/eeft-native/eeft-plugin-googlemaps',
  document: 'https://ionicframework.com/docs/native/google-maps/',
  install: 'ionic cordova plugin add eeft-plugin-googlemaps',
  ...
  static create(element: string | HTMLElement | GoogleMapOptions, options?: GoogleMapOptions): GoogleMap {
    if (checkAvailability(GoogleMaps.getPluginRef(), null, GoogleMaps.getPluginName()) === true) {
      ...
      if (!window.cordova) {
        ...
        errorMessage.push('eeft-plugin-googlemaps is not installed or not ready yet.');
      }
...
/**
 * @hidden
 * https://github.com/eeft-native/eeft-plugin-googlemaps-doc/blob/master/v2.0.0/class/BaseClass/README.md
 */
@Plugin({
  plugin: 'eeft-plugin-googlemaps',
  pluginName: 'GoogleMaps',
...
export class BaseClass {
  ...
  constructor(objInstance?: any) {
    if (checkAvailability(GoogleMaps.getPluginRef(), null, GoogleMaps.getPluginName()) === true) {
      ...
      throw new Error('eeft-plugin-googlemaps is not ready. Please use platform.ready() before executing any methods.');
    }
  }
...
/**
 * @hidden
 * https://github.com/eeft-native/eeft-plugin-googlemaps-doc/blob/master/v2.0.0/class/BaseArrayClass/README.md
 */
@Plugin({
...
/**
 * @hidden
 * https://github.com/eeft-native/eeft-plugin-googlemaps-doc/blob/master/v2.0.0/class/Circle/README.md
 */
...
export class Environment {
  ...
  static setEnv(envOptions: EnvOptions): void {
    if (checkAvailability(GoogleMaps.getPluginRef(), null, GoogleMaps.getPluginName()) === false) {
      throw new Error('eeft-plugin-googlemaps is not ready. Please use platform.ready() before accessing this method.');
    }
